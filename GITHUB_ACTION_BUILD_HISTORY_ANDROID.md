...
| #11 | *진행중* | Flutter 3.24.0 + Firebase 3.15.2/15.2.10 + GitHub Secrets + FCM 서비스 코드 수정 | 🔄 진행중 | FCM 서비스 변수 복원 후 재시도 |
...
- **워크플로우**: Android Build
- **러너**: macos-latest
- **현재 설정**: Flutter 3.24.0 + Firebase 3.15.2/15.2.10 + GitHub Secrets + FCM 서비스 코드 수정
- **상태**: 🔄 11번째 시도 진행 중 (10회 실패 후 FCM 서비스 변수 복원으로 재시도)
