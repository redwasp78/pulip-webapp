    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            Text('앱 이름: ${_packageInfo?.appName ?? 'Pulip WebApp'}'),
            const SizedBox(height: 8),
            Text('버전: ${_packageInfo?.version ?? '1.0.0'}'),
            const SizedBox(height: 8),
            Text('빌드 번호: ${_packageInfo?.buildNumber ?? '1'}'),
            const SizedBox(height: 8),
            Text('패키지명: ${_packageInfo?.packageName ?? 'kr.pe.kk.webapp'}'),
          ],
        ),
        actions: [
          TextButton(
        ...
        builder: (context, appState, child) {
          return ListView(
            ...
            children: [
              ...
              Center(
                child: Text(
                  '버전 ${_packageInfo?.version ?? '1.0.0'} (${_packageInfo?.buildNumber ?? '1'})',
                  style: Theme.of(
                    context,
